  ...
  function scatterGraph() {
    ...
    function chart(selection) {
      selection.each(function() {
        ...
        var scatterContainer = dom
          .append("g")
          .attr("id", "scatter-container")
          .attr("transform", "translate(0," + yPos + ")");

        var backgroundRect = scatterContainer
          .append("rect")
          .attr("class", "scatter-background")
          .attr("height", height)
          .attr("width", width);

        var scatterGroup = scatterContainer
          .append("g")
          .attr("id", "scatter-chart");

        var scatterdots = scatterGroup
          .selectAll(".series")
          .data(data)
          .enter()
          .append("g")
        ...
        var clipCircles = scatterdots
          ...
          .attr("transform", function() {
            return (
              "translate" + "(" + setCircleSize + "," + setCircleSize + ")"
            );
          });

        //Image
        var image = scatterdots
          .append("image")
        ...
        //Rectangle Mask
        var maskGroup = scatterGroup.append("g").attr("class", "mask-rect");
        ...
        function click(d) {
          ...
          overlayRect.transition().attr("height", height);
    ...
    chart.yPos = function(value) {
      ...
      yPos = value;
      if (typeof moveYScatter === "function") moveYScatter();
      return chart;
    };
